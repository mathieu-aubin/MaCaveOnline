		...
		<section>
			<div class="row">
						...
						<div class="panel-body">
							<form action="requetes.php" method='post' role='form' onsubmit="return verif()">
								<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5"><!-- Début zone partie gauche formulaire -->
									...
									<!-- Nom du vin -->
									<div id="nom_vin" class="form-group <?php if (isset($class_nom)) {
                echo $class_nom;
            } ?>">
										...
										<span class='<?php if (isset($class_span_nom)) {
                echo $class_span_nom;
            } ?>'>
                ...
                echo $erreur_nom;
			 						...
			 						<!-- Année -->
			 						<div id="annee_vin" class="form-group <?php if (isset($class_annee)) {
                echo $class_annee;
            } ?>" >
										...
										<span class="<?php if (isset($class_span_annee)) {
                echo $class_span_annee;
            } ?>">
											<?php if (isset($erreur_annee)) {
                echo $erreur_annee;
            } ?>
										</span>
			 						</div>						
			 						<!-- Région -->
									<div id="region_ajout" class="form-group <?php if (isset($class_region)) {
                echo $class_region;
            } ?>">
										<label class="control-label" for="select_region" >Région <span class="obligatoire">*</span></label>
										<?php 
                                            echo $select_region; ?>
										<span class="<?php if (isset($class_span_region)) {
                                                echo $class_span_region;
                                            } ?>">
											<?php if (isset($erreur_region)) {
                                                echo $erreur_region;
                                            } ?>
										</span>
									</div>
									...
									<!-- Type de vin -->
									<div id="type_ajout" class="form-group <?php if (isset($class_type)) {
                                                echo $class_type;
                                            } ?> " > 
										<?php
                                            echo $select_type; ?>	
										<span class="<?php if (isset($class_span_type)) {
                                                echo $class_span_type;
                                            } ?>">
											<?php if (isset($erreur_type)) {
                                                echo $erreur_type;
                                            } ?>
										</span>
									</div>
			 					...
			 					<div class="col-md-5 col-md-offset-2 col-lg-5 col-lg-offset-2">
			 						...
			 						<div id="nb_bouteilles_ajout" class="form-group <?php if (isset($class_bouteilles)) {
                                                echo $class_bouteilles;
                                            } ?>" >
			 							...
			 							<span id="erreur_bt" class="<?php if (isset($class_span_bouteilles)) {
                                                echo $class_span_bouteilles;
                                            } ?>">
			 								<?php if (isset($erreur_bouteilles)) {
                                                echo $erreur_bouteilles;
                                            } ?>
			 							</span>
			 						</div>
			 						...
			 						<!-- Prix d'achat du vin -->
			 						<div id="prix_achat_ajout" class="form-group <?php if (isset($class_achat)) {
                                                echo $class_achat;
                                            } ?>" >
			 							...
			 							<span id="erreur_prix" class="<?php if (isset($class_span_achat)) {
                                                echo $class_span_achat;
                                            } ?>">
			 						...
			 						<!-- Vin offert par -->
			 						<div id="offert_par_ajout" class="form-group <?php if (isset($class_offert)) {
                                                echo $class_offert;
                                            } ?>" >
			 							...
			 							<span id="erreur_offert" class="<?php if (isset($class_span_offert)) {
                                                echo $class_span_offert;
                                            } ?>">
											<?php if (isset($erreur_offert)) {
                                                echo $erreur_offert;
                                            } ?>
										</span>
			 						</div>
