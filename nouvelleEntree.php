<?php
	...
	function insertNewRegion($value)
	{
		...
		$insertNouvelleRegion->bindValue('region', $value, PDO::PARAM_STR);
	...
	function insertNewAoc($value, $region)
	{
		...
		$insertNouvelleAppellation->bindValue('aoc', $value, PDO::PARAM_STR);
	...
	function insertNewLieuAchat($value)
	{
		...
		$insertNouveauLieuAchat->bindValue('lieu_achat', $value, PDO::PARAM_STR);
	...
	function insertNewLieuStockage($value)
	{
		...
		$insertNouveauLieuStockage->bindValue('lieu_stockage', $value, PDO::PARAM_STR);
