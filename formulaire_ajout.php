<?php
	...
	$region = array($ligne_region1, $ligne_region2);
	...
	if(isset($_POST['region']) && $_POST['region'] != '' && $_POST['region'] != 6 && $_POST['region'] != 12) {
		...
		$aoc = array($ligne_aoc1, $ligne_aoc2);
	...
	$type = array($ligne_type1, $ligne_type2);
	...
	$achat = array($ligne_achat1, $ligne_achat2);
	...
	$stockage = array($ligne_stockage1, $ligne_stockage2);
